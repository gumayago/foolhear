...
INSERT INTO cliente (nome, cpf, email, telefone, rua, numero, bairro) VALUES
('joao', '048048', 'joao@email.com', '1111', 'rua A', '10', 'centro'),
('carlos', '036036', 'carlos@email.com', '2222', 'rua B', '20', 'bairro B'),
('ana', '040040', 'ana@email.com', '3333', 'rua C', '30', 'bairro C'),
('teste1', '080080', 'teste@email.com', '4444', 'rua D', '40', 'bairro D');
SELECT * FROM cliente;
...
INSERT INTO livro(nome, descricao, categoria_id) VALUES
('Livro 1', 'descricao 1', 1),
('Livro 2', 'descricao 2', 2),
('Livro 3', 'descricao 3', 3);
SELECT * FROM livro;
