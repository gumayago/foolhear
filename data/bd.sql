...
INSERT INTO cliente (nome, cpf, email, telefone, rua, numero, bairro, img, senha, adm) VALUES
...
('teste1', '080080', 'teste@email.com', '4444', 'rua D', '40', 'bairro D', "https://cdn-icons-png.flaticon.com/512/3135/3135768.png", "senha123", true);
SELECT * FROM cliente;
...
("joao", 'vericiculo profeta biblia'),
("pedro","seguidor de cristo"),
("lucas", "apostolo");
SELECT * FROM estoque;


INSERT INTO livro(nome, descricao, categoria_id, img, autor_id, estoque_id) VALUES
('Livro 1', 'descricao 1', 1, "https://down-br.img.susercontent.com/file/br-11134207-7r98o-ltz8bra2fc6d9f", 1, 2),
('Livro 2', 'descricao 2', 2, "https://fl-storage.bookinfometadados.com.br/uploads/book/first_cover/800_9786599174971.png", 1, 2),
('Livro 3', 'descricao 3', 3, "https://m.media-amazon.com/images/I/91BsZhxCRjL._AC_UF1000,1000_QL80_.jpg", 1, 2);
SELECT * FROM livro;
